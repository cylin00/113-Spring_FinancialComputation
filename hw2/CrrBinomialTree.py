...
# print("\nCRR Binomial Tree - Basic")
# print("Euprean Call:", GetEuropeanOptionValue(S0, K, r, q, sigma, T, n_1, 'call'))
# print("European Put:", GetEuropeanOptionValue(S0, K, r, q, sigma, T, n_1, 'put'))
# print("American Call:", GetAmericanOptionValue(S0, K, r, q, sigma, T, n_1, 'call'))
# print("American Put:", GetAmericanOptionValue(S0, K, r, q, sigma, T, n_1, 'put'))

# print("\nCRR Binomial Tree - One Column Vector")
# print("European Call:", GetEuropean_1D(S0, K, r, q, sigma, T, n_1, 'call'))
# print("European Put:", GetEuropean_1D(S0, K, r, q, sigma, T, n_1, 'put'))
# print("American Call:", GetAmerican_1D(S0, K, r, q, sigma, T, n_1, 'call'))
# print("American Put:", GetAmerican_1D(S0, K, r, q, sigma, T, n_1, 'put'))

# print("\nCRR Binomial Tree - Basic")
# print("Euprean Call:", GetEuropeanOptionValue(S0, K, r, q, sigma, T, n_2, 'call'))
# print("European Put:", GetEuropeanOptionValue(S0, K, r, q, sigma, T, n_2, 'put'))
# print("American Call:", GetAmericanOptionValue(S0, K, r, q, sigma, T, n_2, 'call'))
# print("American Put:", GetAmericanOptionValue(S0, K, r, q, sigma, T, n_2, 'put'))

# print("\nCRR Binomial Tree - One Column Vector")
# print("European Call:", GetEuropean_1D(S0, K, r, q, sigma, T, n_2, 'call'))
# print("European Put:", GetEuropean_1D(S0, K, r, q, sigma, T, n_2, 'put'))
# print("American Call:", GetAmerican_1D(S0, K, r, q, sigma, T, n_2, 'call'))
# print("American Put:", GetAmerican_1D(S0, K, r, q, sigma, T, n_2, 'put'))

# print("\nCombinatorial Method")
# print("European Call:", GetEuropean_Combinatorial(S0, K, r, q, sigma, T, n_3, 'call'))
# print("European Put:", GetEuropean_Combinatorial(S0, K, r, q, sigma, T, n_3, 'put'), "\n")